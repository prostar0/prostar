...
typedef	enum {
	...
	VIDOUT_1920x1080p29,		// 1920x1080p 29.97Hz
...
*/	// modified on 22Oct2013
	MDIN_4CHVIEW_ALL = 0,		// 4CH-display is all 4-split screen
	MDIN_4CHVIEW_CH01,			// 4CH-display is only ch01 screen
	MDIN_4CHVIEW_CH02,			// 4CH-display is only ch02 screen
	MDIN_4CHVIEW_CH03,			// 4CH-display is only ch03 screen
	MDIN_4CHVIEW_CH04,			// 4CH-display is only ch04 screen
	MDIN_4CHVIEW_CH12H,			// 4CH-display is dual ch01/ch02 screen, horizontal direction
	MDIN_4CHVIEW_CH34H,			// 4CH-display is dual ch03/ch04 screen, horizontal direction
	MDIN_4CHVIEW_CH13H,			// 4CH-display is dual ch01/ch03 screen, horizontal direction
	MDIN_4CHVIEW_CH24H,			// 4CH-display is dual ch02/ch04 screen, horizontal direction
	MDIN_4CHVIEW_CH14H,			// 4CH-display is dual ch01/ch04 screen, horizontal direction
	MDIN_4CHVIEW_CH23H,			// 4CH-display is dual ch02/ch03 screen, horizontal direction
	MDIN_4CHVIEW_CH12V,			// 4CH-display is dual ch01/ch02 screen, vertical direction
	MDIN_4CHVIEW_CH34V,			// 4CH-display is dual ch03/ch04 screen, vertical direction
	MDIN_4CHVIEW_CH13V,			// 4CH-display is dual ch01/ch03 screen, vertical direction
	MDIN_4CHVIEW_CH24V,			// 4CH-display is dual ch02/ch04 screen, vertical direction
	MDIN_4CHVIEW_CH14V,			// 4CH-display is dual ch01/ch04 screen, vertical direction
	MDIN_4CHVIEW_CH23V,			// 4CH-display is dual ch02/ch03 screen, vertical direction
...
typedef enum {
	MDIN_ENC_TEST_DISABLE = 0,		// disable input test pattern
	MDIN_ENC_TEST_WINDOW,			// window test pattern
	MDIN_ENC_TEST_H_RAMP,			// horizontal ramp pattern
	MDIN_ENC_TEST_V_RAMP,			// vertical ramp pattern
	MDIN_ENC_TEST_H_GRAY,			// horizontal gray scale pattern
	MDIN_ENC_TEST_V_GRAY,			// vertical gray scale pattern
	MDIN_ENC_TEST_H_COLOR100,		// horizontal color bar pattern 100IRE
	MDIN_ENC_TEST_H_COLOR75			// horizontal color bar pattern 75 IRE
...
MDIN_ERROR_t MDIN3xx_SetMemoryReAlloc(PMDIN_VIDEO_INFO pINFO);	// added on 30Dec2015
...
MDIN_ERROR_t MDIN3xx_SetLineDeci(BYTE dfactor);			// added on 30Dec2015
MDIN_ERROR_t MDIN3xx_EnableDigitalBypass(BOOL OnOff, BOOL MODE444, BYTE nID); // nID: 1 (port A), 0 (port B) added on 30Dec2015
MDIN_ERROR_t MDIN3xx_EnableDACBypass(BOOL OnOff, MDIN_CLK_DELAY_t delay);	// added on 22Oct2013
MDIN_ERROR_t MDIN3xx_EnableHDMIBypass(BOOL OnOff, PMDIN_VIDEO_INFO pINFO, BYTE nID);	// added on 22Oct2013
...
MDIN_ERROR_t MDINAUX_SetOutTestPattern(MDIN_OUT_TEST_t mode);	// 01Jul2014
MDIN_ERROR_t MDINAUX_SetEncTestPattern(PMDIN_VIDEO_INFO pINFO, MDIN_ENC_TEST_t mode); // 01Jul2014
